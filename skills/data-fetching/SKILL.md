---
name: data-fetching
description: Networking in an Expo or React Native app. Use when implementing or debugging a network request, API call, or data fetching in Expo — fetch, axios, React Query, SWR, error handling, caching, offline support, token handling, API URL configuration. Do NOT use for server-side or non-React-Native networking; the content is Expo-specific throughout.
version: 1.0.0
license: MIT
---
